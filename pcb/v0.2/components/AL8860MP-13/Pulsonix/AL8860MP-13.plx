...
(library Library_1
	...
	(patternDef "SOP65P490X110-9N" (originalName "SOP65P490X110-9N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.475 1.5) (pt 1.475 1.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.475 1.5) (pt 1.475 -1.5) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.475 0.85) (pt -0.825 1.5) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "AL8860MP-13" (originalName "AL8860MP-13") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "SET") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "2" (pinName "GND_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "3" (pinName "GND_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "4" (pinName "CTRL") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/AL8860MP-13.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "AL8860MP-13.stp")
